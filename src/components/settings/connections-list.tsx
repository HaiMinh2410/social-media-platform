              ...
              {platformAccounts.length > 0 ? (
                platformAccounts.map((account) => (
                  <div key={account.id} className="p-6 flex items-center justify-between hover:bg-slate-50 transition-colors group">
                      <Link 
                        href={`/settings/connections/${account.id}`}
                      ...
                      >
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="font-semibold text-slate-900 group-hover:text-indigo-600 transition-colors">{account.platform_user_name}</span>
